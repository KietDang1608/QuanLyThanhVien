...
public class ThongKeBUS {
    ...
    public ArrayList<ThongTinSD> getListTTSDFromStart(String startDate, String startTime){
        ThongTinSDBUS ttsdBUS = new ThongTinSDBUS();
        //Date : yyyy-mm-dd
        //Time : hh-mm-ss
        ArrayList<ThongTinSD> lstFound = new ArrayList<>();
    ...
    public ArrayList<ThongTinSD> getListTTSDBeforeEnd(String endDate, String endTime){
        ThongTinSDBUS ttsdBUS = new ThongTinSDBUS();
        //Date : yyyy-mm-dd
        //Time : hh-mm-ss
        ArrayList<ThongTinSD> lstFound = new ArrayList<>();
...
//        }
        for (ThongTinSD tt:tkbus.getListTTSDFromStart("2024-04-01","00:00:00")){
            System.out.println(tt.toString());
